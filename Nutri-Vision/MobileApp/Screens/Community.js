...
/**
 * Displays a list of community posts related to recipes, with the ability to search through them.
 * Each post includes an image, title, duration, and the name of the poster. The search function
 * filters the posts based on the title.
 *
 * @component
 * @example
...
const CommunityScreen = () => {
    ...
    /**
   * Filters posts based on the user's search query. This function is integrated within the
   * CommunityScreen component and is triggered whenever the user types into the search bar.
   *
   * @function filteredPosts
   * @param {string} searchQuery - The search query used to filter the posts.
