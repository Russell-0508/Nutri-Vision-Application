...
/**
 * Provides a user interface for creating a new user profile with fields for name, gender, date of birth,
 * height, weight, and avatar selection. The form ensures all fields are validated before submitting the
 * data to a Firestore collection.
 *
 * @component
...
const CreateProfile = ({ navigation }) => {
    ...
    /**
     * Handles the submission of the profile form. Validates all form fields for correctness and completeness,
     * calculates the user's age, and submits the data to Firestore. Alerts the user in case of validation failures
     * or informs them upon successful creation of the profile.
     *
     * @async
    ...
    /**
     * Manages date input changes and updates component state. Hides the date picker upon selection.
     *
     * @function onChangeDate
     * @param {Event} event - The event object associated with the change of input.
    ...
    /**
     * Triggers the display of the date picker for the date of birth selection.
     *
    ...
    /**
     * Validates and sets the height based on the user's input. Provides feedback for invalid inputs.
     *
     * @function handleHeightChange
     * @param {string} text - The input text from the height input field.
     */
    ...
    /**
     * Validates and sets the weight based on the user's input. Provides feedback for invalid inputs.
     *
     * @function handleWeightChange
     * @param {string} text - The input text from the weight input field.
     */
    ...
    /**
     * Calculates the Body Mass Index (BMI) based on the height and weight entered by the user. Sets the BMI and
     * categorizes it into different health ranges.
     *
